...
(function () {
  ...
  const T = {
    ...
    "hero.eyebrow.credentials": { en:"Since 1995 · ISO 9001 · 80+ Countries", zh:"1995年创立 · ISO 9001 · 80+国家", es:"Desde 1995 · ISO 9001 · 80+ países", ru:"С 1995 г. · ISO 9001 · 80+ стран", ar:"منذ 1995 · ISO 9001 · 80+ دولة", tr:"1995'ten beri · ISO 9001 · 80+ Ülke", fr:"Depuis 1995 · ISO 9001 · 80+ pays", pt:"Desde 1995 · ISO 9001 · 80+ países", hi:"1995 से · ISO 9001 · 80+ देश", id:"Sejak 1995 · ISO 9001 · 80+ Negara" },
    "hero.title":       { en:"HVAC Duct Machinery.<br/>Built to Produce.", zh:"暖通风管机械。<br/>为持续生产而生。", es:"Maquinaria para conductos HVAC.<br/>Fabricada para producir.", ru:"Оборудование для воздуховодов HVAC.<br/>Создано для производства.", ar:"آلات مجاري هواء HVAC.<br/>مصممة للإنتاج.", tr:"HVAC Kanal Makineleri.<br/>Üretim İçin Yapıldı.", fr:"Machines de conduits HVAC.<br/>Conçues pour produire.", pt:"Máquinas de dutos HVAC.<br/>Feitas para produzir.", hi:"HVAC डक्ट मशीनरी।<br/>उत्पादन के लिए बनाई गई।", id:"Mesin Saluran HVAC.<br/>Dirancang untuk Berproduksi." },
    "hero.lead":        { en:"Auto duct lines and spiral tubeformers — built for factory output.", zh:"全自动风管线与螺旋成型机——为工厂产能而生。", es:"Líneas automáticas de conductos y tubeformers espirales — listos para producción.", ru:"Автоматические линии воздуховодов и спиральные трубоформеры — для заводского производства.", ar:"خطوط قنوات تلقائية وآلات تشكيل حلزونية — مصممة للإنتاج المصنعي.", tr:"Otomatik kanal hatları ve spiral şekillendiriciler — fabrika üretimi için.", fr:"Lignes automatiques de conduits et tubeformers spiralés — pour la production en usine.", pt:"Linhas automáticas de dutos e tubeformers espirais — para produção industrial.", hi:"ऑटो डक्ट लाइनें और स्पाइरल ट्यूबफॉर्मर — फैक्टरी उत्पादन के लिए।", id:"Jalur saluran otomatis dan tubeformer spiral — untuk output pabrik." },
    ...
    "hero.cta.machines": { en:"View Machines", zh:"查看设备", es:"Ver Máquinas", ru:"Смотреть оборудование", ar:"عرض الآلات", tr:"Makineleri Gör", fr:"Voir les Machines", pt:"Ver Máquinas", hi:"मशीनें देखें", id:"Lihat Mesin" },
