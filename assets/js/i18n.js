...
(function () {
  ...
  const T = {
    ...
    "hero.title":       { en:"HVAC Duct Machinery<br/>Built for Production.", zh:"暖通风管机械<br/>为生产而生。", es:"Maquinaria para conductos HVAC<br/>Fabricada para producción.", ru:"Оборудование для воздуховодов HVAC<br/>Создано для производства.", ar:"آلات مجاري هواء HVAC<br/>مصممة للإنتاج.", tr:"HVAC Kanal Makineleri<br/>Üretime Hazır.", fr:"Machines de conduits HVAC<br/>Conçues pour la production.", pt:"Máquinas de dutos HVAC<br/>Feitas para produção.", hi:"HVAC डक्ट मशीनरी<br/>उत्पादन के लिए बनाई।", id:"Mesin Saluran HVAC<br/>Dirancang untuk Produksi." },
    "hero.lead":        { en:"Auto duct lines, spiral tubeformers, complete factory design — 80+ countries since 1995.", zh:"全自动风管线、螺旋成型机、完整工厂设计——80+国家，深耕30年。", es:"Líneas automáticas, tubeformers espirales, diseño de fábrica completo — 80+ países desde 1995.", ru:"Автоматические линии, спиральные трубоформеры, полное проектирование — 80+ стран с 1995 г.", ar:"خطوط تلقائية وآلات تشكيل حلزونية وتصميم مصنع متكامل — 80+ دولة منذ 1995.", tr:"Otomatik kanal hatları, spiral şekillendiriciler, tam fabrika tasarımı — 1995'ten beri 80+ ülke.", fr:"Lignes automatiques, tubeformers spiralés, conception d'usine complète — 80+ pays depuis 1995.", pt:"Linhas automáticas, tubeformers espirais, projeto completo de fábrica — 80+ países desde 1995.", hi:"ऑटो डक्ट लाइनें, स्पाइरल ट्यूबफॉर्मर, पूर्ण फैक्टरी डिज़ाइन — 1995 से 80+ देश।", id:"Jalur duct otomatis, tubeformer spiral, desain pabrik lengkap — 80+ negara sejak 1995." },
    ...
    "hero.cta.watch":   { en:"Watch machines running", zh:"观看设备运行", es:"Ver máquinas en acción", ru:"Смотреть оборудование", ar:"شاهد الآلات تعمل", tr:"Makineleri izle", fr:"Voir les machines", pt:"Ver máquinas", hi:"मशीनें देखें", id:"Lihat mesin" },
